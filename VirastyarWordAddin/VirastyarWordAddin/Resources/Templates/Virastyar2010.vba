Public Function GetVirastyarObject() As Object
    ...
    If addIn Is Nothing Then ' Office 2010
...
End Sub
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Sub VirastyarAddinGroup_IsVisible(control As IRibbonControl, ByRef visible)
    visible = VirastyarUpdate_IsVisible
End Sub

Sub VirastyarUpdate_IsVisible(control As IRibbonControl, ByRef visible)
    Dim virastyar As Object
    Set virastyar = GetVirastyarObject
    If Not virastyar Is Nothing Then
...
Sub VirastyarUpdate_IsEnabled(control As IRibbonControl, ByRef enabled)
    enabled = True
End Sub
